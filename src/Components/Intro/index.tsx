          ...
          <div className='flex flex-col'>
            ...
            <div className="flex flex-col items-center w-full pt-10 gap-y-4 sm:hidden">
              ...
              <div className="flex w-[100%] items-center justify-between gap-x-4 mr-4 text-xl">
                <a aria-label="social-link" className="p-2 text-white transition rounded cursor-pointer socials dark:text-gray-700 dark:hover:text-pink-600 hover:text-pink-400 bg-white/20 backdrop-blur dark:bg-neutral-950/20" href="https://www.github.com/Anshkaran7" target="_blank" rel="noopener noreferrer">
                ...
                <a aria-label="social-link" className="p-2 text-white transition rounded cursor-pointer socials dark:text-gray-700 dark:hover:text-pink-600 hover:text-pink-400 bg-white/20 backdrop-blur dark:bg-neutral-950/20" href="https://www.instagram.com/Anshkaran7" target="_blank" rel="noopener noreferrer">
